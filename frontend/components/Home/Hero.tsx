  ...
  return (
    <div className="relative h-screen ">
      ...
      <div className=" flex flex-col lg:flex-row justify-center gap-9">
        ...
        <div className="w-[80vw] sm:w-[25rem] mx-auto lg:mx-20 lg:-translate-x-32 flex flex-col gap-2 lg:h-screen justify-center">
          <h1 className="hidden lg:block font-bold text-5xl italic">
            Whereabouts
          </h1>
        ...
        <div className="hidden lg:grid lg:grid-rows-3 grid-flow-col h-full my-auto rotate-45 gap-2">
